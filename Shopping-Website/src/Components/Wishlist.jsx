...
export default function Wishlist() {
  ...
  return (
    <>
    <Container maxWidth='md' sx={{pt:4, pb:{xs:13, sm:8, md:6}}}>
            ...
            <Grid item key={id} xs={6} sm={6}>
              <Card sx={{height:'100%', display: 'flex' , flexDirection:'column'}}>
                ...
                <CardContent >
                  ...
                  <Typography sx={{fontSize: { xs:'15px', sm: '20px' }}} component='span'>${price}</Typography>
                  <Typography sx={{fontSize:{ xs:'12px', sm: '15px' }, ml: 1, color: '#e63946'}} component='span'>({discountPercentage}% OFF)</Typography>
                </CardContent>
                ...
                <CardActions 
                  sx={{
                    ...
                    <Button sx={{margin: 'auto'}}  onClick={() => addProductToCart({title, id, price, images, description, rating }) }>
                      Move to cart
                    </Button>
                </CardActions>
